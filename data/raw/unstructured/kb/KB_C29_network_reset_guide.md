# Resetting Device Network Settings for Persistent Connectivity Issues

**Document ID:** KB_C29_network_reset_guide
**Category:** C29 — Technical Support & Troubleshooting
...
This article explains how technical support & troubleshooting issues in this area are diagnosed and resolved, and what customers and front-line agents should check before escalating.
...
- If the standard steps above do not resolve the issue, escalate with reference to: FAQ_C29_001.
