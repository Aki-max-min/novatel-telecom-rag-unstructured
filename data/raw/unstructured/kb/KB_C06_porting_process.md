# End-to-End Guide to Number Porting (MNP)

**Document ID:** KB_C06_porting_process
...
This article explains how number portability (mnp) issues in this area are diagnosed and resolved, and what customers and front-line agents should check before escalating.
...
- If the standard steps above do not resolve the issue, escalate with reference to: FAQ_C06_001.
