# Resolving My NovaTel App Login and OTP Issues

**Document ID:** KB_C13_selfcare_login_issues
...
This article explains how app & self-care portal issues in this area are diagnosed and resolved, and what customers and front-line agents should check before escalating.
...
- If the standard steps above do not resolve the issue, escalate with reference to: FAQ_C13_001.
