# Closing or Reactivating a Deactivated Connection

**Document ID:** KB_C21_account_closure
...
This article explains how termination & deactivation issues in this area are diagnosed and resolved, and what customers and front-line agents should check before escalating.
...
- If the standard steps above do not resolve the issue, escalate with reference to: FAQ_C21_001.
